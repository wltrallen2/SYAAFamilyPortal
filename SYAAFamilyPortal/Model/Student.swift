...
struct Student: Equatable {
    ...
    static let `default` = Student(birthdate: Date(timeIntervalSinceNow: TimeInterval(-60 * 60 * 24 * 365 * 6)), school: "May-Allen Academy", teacher: nil, currentGrade: 2, expectedGraduation: Date(timeIntervalSinceNow: TimeInterval(60 * 60 * 24 * 365 * 12)), notes: "Such an awesome kiddo", profileColor: UIColor(red: 255/255, green: 182/255, blue: 203/255, alpha: 1.0), headshotURL: nil, auditionVideoURL: nil)
}
